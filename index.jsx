    ...
    <div className="min-h-screen bg-gradient-to-b from-sky-50 via-indigo-50 to-white p-6">
      <div className="max-w-6xl mx-auto space-y-5">
        ...
        <Modal open={slotModalOpen} title={`Choose ${slotKey === 'hotel' ? 'Hotel / Area' : slotKey.charAt(0).toUpperCase()+slotKey.slice(1)}`} onClose={()=>setSlotModalOpen(false)}>
          ...
          <SuggestionList items={liveItems} onChoose={chooseForSlot} loading={usingApi ? liveLoading : false} error={usingApi ? liveError : 'API not configured'} usingApi={usingApi}/>
        </Modal>
